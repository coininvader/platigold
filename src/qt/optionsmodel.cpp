...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizePlatiGoldAmount"))
        settings.setValue("nAnonymizePlatiGoldAmount", 1000);
    nAnonymizePlatiGoldAmount = settings.value("nAnonymizePlatiGoldAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizePlatiGoldAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizePlatiGoldAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizePlatiGoldAmount:
            return QVariant(nAnonymizePlatiGoldAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizePlatiGoldAmount:
            nAnonymizePlatiGoldAmount = value.toInt();
            settings.setValue("nAnonymizePlatiGoldAmount", nAnonymizePlatiGoldAmount);
            emit AnonymizePlatiGoldAmountChanged(nAnonymizePlatiGoldAmount);
            break;
        default:
            break;
        }
