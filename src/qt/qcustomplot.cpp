...
QCustomPlot::QCustomPlot(QWidget *parent) :
  ...
  mCurrentLayer(0),
  mPlottingHints(QCP::phCacheLabels|QCP::phPlatiGoldRepaint),
...
void QCustomPlot::replot(QCustomPlot::RefreshPriority refreshPriority)
{
  ...
  if (painter.isActive())
  {
    ...
    draw(&painter);
    painter.end();
    if ((refreshPriority == rpHint && mPlottingHints.testFlag(QCP::phPlatiGoldRepaint)) || refreshPriority==rpImmediate)
      repaint();
    else
      update();
