...
private slots:
    ...
    QString BuyPTG(QString OrderType, double Quantity, double Rate);
    QString SellPTG(QString OrderType, double Quantity, double Rate);
