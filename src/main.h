...
static const int64_t TARGET_SPACING = 60; // 1 minute
...
void ResendWalletTransactions(bool fPlatiGold = false);
...
protected:
    ...
    virtual void ResendWalletTransactions(bool fPlatiGold) =0;
