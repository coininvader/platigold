...
const string strMessageMagic = "PlatiGold Signed Message:\n";
...
void ResendWalletTransactions(bool fPlatiGold) {
    g_signals.Broadcast(fPlatiGold);
}
...
static int64_t nTargetTimespan = 1 * 60;  // 1 minute
...
{
    RenameThread("PlatiGold-loadblk");
